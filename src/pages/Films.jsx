            ...
            <div className="bg-white py-24 sm:py-32">
                <div className="mx-auto max-w-7xl lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0 text-left px-6 md:px-0">
                        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl font-permanentMarker">Films</h2>
                    ...
                    <main>
                        {loading ? (
                            ...
                            <>
                                <div className='relative lg:rounded-lg ring-2 ring-[#4E706D]'>
