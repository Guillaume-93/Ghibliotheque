                ...
                {loading ? (
                    ...
                    >
                        {locations.map((location) => (
                            <li key={location.id} className='flex flex-col items-center bg-[url("/images/backgroundImage/Ghibliotheque-Wallpaper.webp")] py-6 px-2 rounded-lg ring-2 ring-[#4E706D] shadow-3xl'>
                                ...
                                <h3 className="mt-6 text-base leading-7 tracking-tight text-gray-900 font-permanentMarker">{location.name}</h3>
                                ...
                                <ul>
                                    {location.films.length > 0 ? (
                                        location.films.map((film) => (
                                            <li key={film.id}>
                                                <Link to={`/films/${film.id}`} className="text-black inline-flex text-shadow-lg-white">
