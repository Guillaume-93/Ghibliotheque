                ...
                {loading ? (
                    ...
                    <div className="mx-auto flex max-w-2xl flex-col justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
                        <div className="w-full lg:max-w-lg lg:flex-auto">
                            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl font-permanentMarker">
                                {film.title}
                            </h2>
                        ...
                        <div className="w-full lg:max-w-xl lg:flex-auto">
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-8'>
                                <ul className='col-span-2 mt-10'>
                                    <h3 className="text-2xl font-bold mb-4 font-permanentMarker">Characters</h3>
                                ...
                                <ul className='col-span-1 mt-10'>
                                    <h3 className="text-2xl font-bold mb-4 font-permanentMarker">Species</h3>
                            ...
                            <ul className='col-span-1 mt-10'>
                                <h3 className="text-2xl font-bold mb-4 font-permanentMarker">Vehicles</h3>
